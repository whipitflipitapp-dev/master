...
export function SplashHome() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-1 flex-col overflow-hidden bg-neutral-950 pb-[calc(3.75rem+0.75rem+env(safe-area-inset-bottom))]">
      ...
      <header className="relative z-10 flex items-start justify-between max-sm:justify-end px-5 pt-4">
        <div className="ml-12 flex max-sm:hidden flex-col gap-1 leading-none drop-shadow-[0_2px_8px_rgba(0,0,0,0.65)] sm:ml-14">
