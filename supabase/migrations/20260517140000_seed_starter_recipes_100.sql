...
-- Food-matched JPEGs: node scripts/fetch-starter-recipe-covers.mjs (TheMealDB / Foodish / optional Unsplash).
...
(
  ...
  $instr$Mix ground lamb with spices, shape into skewers, and grill. Serve with cucumber yogurt sauce.$instr$,
  '/recipes/starter-070.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Shred jackfruit, simmer with orange and spices, crisp in a skillet. Serve in tortillas.$instr$,
  '/recipes/starter-074.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Steam mussels in white wine and garlic, finish with butter and parsley.$instr$,
  '/recipes/starter-076.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  $instr$Simmer mini meatballs and greens in chicken broth with orzo.$instr$,
  '/recipes/starter-082.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Blend chickpeas with herbs, form balls, and bake until crisp. Stuff in pita with tahini sauce.$instr$,
  '/recipes/starter-084.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Cook red lentils with coconut milk, ginger, and tomatoes until creamy.$instr$,
  '/recipes/starter-085.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  'Maple bourbon ribs',
  $instr$Rub ribs with brown sugar and spice, smoke low and slow, glaze with maple and bourbon.$instr$,
  '/recipes/starter-087.jpg',
  NULL,
  0,
  NULL,
  'hard',
...
(
  ...
  'Kale apple salad',
  $instr$Massage kale with lemon dressing, toss with sliced apple and toasted pecans.$instr$,
  '/recipes/starter-088.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  $instr$Slice cauliflower into thick slabs, roast with smoked paprika until caramelized.$instr$,
  '/recipes/starter-089.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  $instr$Bake sweet potatoes until tender, fill with black beans, corn, and avocado.$instr$,
  '/recipes/starter-090.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  $instr$Toss cooked orzo with feta, sun-dried tomatoes, and olives. Bake until golden on top.$instr$,
  '/recipes/starter-091.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  $instr$Roast squash, blend with broth and cream, season with nutmeg.$instr$,
  '/recipes/starter-092.jpg',
  NULL,
  0,
  NULL,
  'easy',
...
(
  ...
  'Farro beet salad',
  $instr$Cook farro, toss with roasted beets, goat cheese, and arugula.$instr$,
  '/recipes/starter-093.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Grill chicken pieces, toss in tangy mayo-vinegar white sauce before serving.$instr$,
  '/recipes/starter-094.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  $instr$Mix crab with binder, pan-fry cakes until golden. Serve with tangy remoulade.$instr$,
  '/recipes/starter-097.jpg',
  NULL,
  0,
  NULL,
  'medium',
...
(
  ...
  'Three-bean chili',
  $instr$Simmer kidney, black, and pinto beans with tomatoes and chili spices.$instr$,
  '/recipes/starter-100.jpg',
  NULL,
  0,
  NULL,
  'easy',
